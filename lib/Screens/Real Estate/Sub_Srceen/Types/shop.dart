...
class _ShopPropertyPageState extends State<ShopPropertyPage> {
  ...
  Future<List<OfficePropertyModel>> fetchOfficeProperties() async {
    ...
    final url = Uri.parse(
      "https://verifyrealestateandservices.in/Second%20PHP%20FILE/main_application/Shop.php?user_id=$userId",
    );
              ...
              if (data == null || data.isEmpty) {
                return Center(
                    child: Column(
                      children: [
                        SizedBox(height: 100,),
                        Text("No Shop properties found.",style: TextStyle(color: Colors.black)),
                      ],
                    )
                );
              }
