...
class ShopPropertyPage extends StatefulWidget {
  const ShopPropertyPage({super.key});

  @override
  State<ShopPropertyPage> createState() => _ShopPropertyPageState();
}

class _ShopPropertyPageState extends State<ShopPropertyPage> {
  ...
  Future<List<OfficePropertyModel>> fetchOfficeProperties() async {
    final url = Uri.parse(
      "https://verifyserve.social/PHP_Files/showdata_shops_api/insert.php",
    );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Shops Properties",style: const TextStyle(fontSize: 20, fontFamily: 'Poppins'),
        ),
      ...
      body: FutureBuilder<List<OfficePropertyModel>>(
        ...
        builder: (context, snapshot) {
          ...
          if (data == null || data.isEmpty) {
            return const Center(child: Text("No Shop properties found."));
          }
