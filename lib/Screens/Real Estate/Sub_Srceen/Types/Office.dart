...
class _OfficePropertyPageState extends State<OfficePropertyPage> {
  ...
  Future<List<OfficePropertyModel>> fetchOfficeProperties() async {
    final url = Uri.parse("https://verifyserve.social/PHP_Files/showapiforwebsite_office/insert.php");
          ...
          FutureBuilder<List<OfficePropertyModel>>(
            ...
            builder: (context, snapshot) {
              ...
              if (data == null || data.isEmpty) {
                return const Center(child: Text("No office properties found.",style: TextStyle(color: Colors.black)));
              }
