...
class _OfficePropertyPageState extends State<OfficePropertyPage> {
  ...
  Future<List<OfficePropertyModel>> fetchOfficeProperties() async {
    final url = Uri.parse(
      "https://verifyserve.social/PHP_Files/showapiforwebsite_office/insert.php",
    );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Office Properties",style: const TextStyle(fontSize: 20, fontFamily: 'Poppins'),
        ),
